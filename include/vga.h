...
extern void VGA_SetupAttr(void);
extern void VGA_SetupDAC(void);
extern void VGA_SetupCRTC(void);
extern void VGA_SetupMisc(void);
extern void VGA_SetupGFX(void);
extern void VGA_SetupSEQ(void);
extern void VGA_SetupOther(void);
