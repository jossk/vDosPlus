...
extern TTF_Font* TTF_New_Memory_Face(const unsigned char* file_base, long file_size, int ptsize, char* fName);
...
#define TTF_STYLE_SUBSCRIPT		0x10
#define TTF_STYLE_SUPERSCRIPT	0x20
#define TTF_STYLE_SMALL			0x40
#define TTF_STYLE_DOUBLEUNDERLINE	0x80
...
*/
extern vSurface* TTF_RenderASCII(TTF_Font* font, TTF_Font *fontb, TTF_Font *fonti, TTF_Font *fontbi, const char* text, int textlen, RGB_Color fg, RGB_Color bg, int style);
