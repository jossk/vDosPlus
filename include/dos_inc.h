...
bool DOS_GetFileAttrEx(char const* const name, LPVOID fad, Bit8u hdrive=-1);
...
public:
	...
	void SetupSearch(Bit8u _sdrive,int handle,Bit8u _sattr,Bit8u _rattr,char * _pattern);
	void SetResult(int handle,const char * _name,const char * _lname,Bit32u _hsize,Bit32u _size,Bit16u _date,Bit16u _time,Bit16u _adate,Bit16u _atime,Bit16u _cdate,Bit16u _ctime,Bit8u _attr);
	
	int GetFindData(int fmt,char * finddata,int *c);
	Bit8u GetSearchDrive(int handle);
	void GetSearchParams(int handle,Bit8u & _sattr,Bit8u & _rattr,char * _spattern);
	void GetResult(int handle,char * _name,char * _lname,Bit32u & _size,Bit16u & _date,Bit16u & _time,Bit8u & _attr);
...
public:
	...
	void SetResult(Bit32u _size,Bit16u _date,Bit16u _time,Bit8u _attr);
