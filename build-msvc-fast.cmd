...
cd freetype
call build-msvc-fast.cmd
cd ..

del *.obj
rc /nologo  /fo "winres.res" ./src/winres.rc
cl /nologo /Qpar /GS- /guard:cf- /GA /MT /EHsc /DWIN32 /DNDEBUG /D_WINDOWS /I.\include /I.\freetype\include /I.\freetype\include\freetype /Yc"stdafx.h" .\src\stdafx.cpp
cl /nologo /Qpar /GS- /guard:cf- /GA /MT /EHsc /DWIN32 /DNDEBUG /D_WINDOWS /I.\include /I.\freetype\include /I.\freetype\include\freetype /Yu"stdafx.h" ^
/Fe"vDosPlus-msvc-fast.exe" ^
