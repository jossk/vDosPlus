...
cd freetype
call build-mingw-fast.cmd
cd ..

g++ -c -O0 -DWIN32 -DNDEBUG -D_WINDOWS -I.\include -I.\freetype\include -I.\freetype\include\freetype ^
...
g++ -v -L .\freetype -o vDosPlus-mingw-fast.exe *.o -lkernel32 -luser32 -lgdi32 -lshell32 -lshlwapi -lfreetype
